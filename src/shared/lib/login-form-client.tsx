    ...
    >
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-balance text-xs text-muted-foreground">
          Entre com seu email e senha para logar na sua conta
        </p>
      </div>
      <div className="grid gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Button variant="outline" className="w-full" onClick={SignUpGitHub}>
      ...
      <div className="text-center text-sm">
        Não tem uma conta?{" "}
        <a href="/signup" className="underline underline-offset-4 text-sky-600">
          Criar conta
        </a>
      </div>
    </form>
